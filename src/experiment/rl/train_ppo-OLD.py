...
def load_optuna_params(algo_name):
    ...
    if algo_name == "PPO":
        filename = PATH_OPTUNA_PARAM_PPO
    elif algo_name == "LeakyPPO":
        filename = PATH_OPTUNA_PARAM_LEAKY_PPO
    else:
...
# ============== CONFIGURATIONS =============
PATH_OPTUNA_PARAM_PPO = "ppo_metadrive_optuna_1.5M_best_params.json"
PATH_OPTUNA_PARAM_LEAKY_PPO = "leaky_ppo_metadrive_optuna_1.5M_best_params.json"
...
TRAIN_CONFIG = {
        ...
        "success_reward": 30.0,        # Default is 200.0
